...
import myImage from "../../../public/images/Profile Photoc.png"
  ...
  return (
    ...
    <div className="flex md:flex-row flex-col md:m-20 m-10 gap-16 justify-between">
      ...
      <h1 className="lg:text-5xl text-4xl">
        Hi I&apos;m Muneeb Ahmed, Frontend Web Developer
      </h1>
      <p className="text-lg">Hello! I am Muneeb Ahmed, I am a web developer with 2 years of frontend and 1 year of backend experince, I have developed several website with my professional skills and help many businesses to grow in the market.</p>
    ...
    <div className="flex flex-col gap-24 md:mx-20 mx-10 my-32 lg:w-[50%] md:w-[70%]">
      <div className="flex sm:flex-row flex-col md:gap-20 gap-10">
        ...
        <p className="text-lg lg:w-[70%]">E-Commerce-Website, Personal Portfolio Website and Resume Builder</p>
      </div>

      <div className="flex sm:flex-row flex-col md:gap-20 gap-10">
        <h1 className="text-xl font-semibold underline lg:w-[30%] sm:w-[42%]">Main Skills</h1>
        <p className="text-lg lg:w-[70%]">HTML, CSS, JavaScript, TypeScript, Next.js and Tailwind.</p>
      ...
      <div className="flex sm:flex-row flex-col  justify-between gap-12 md:mx-20 mx-10 my-20">
        ...
        <h2 className="text-lg font-semibold sm:mb-4">muneebkhuhro6427@gmail.com</h2>
